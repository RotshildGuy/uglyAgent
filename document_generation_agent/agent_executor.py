...
class DocumentGenerationAgentExecutor(AgentExecutor):
    """An AgentExecutor that runs the Document Generation Agent."""

    def __init__(self, runner: Runner):
        self.runner = runner
        self._running_sessions = {}
        self.user_id = "document_generation_agent_user"
